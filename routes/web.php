...
Route::get('/cetak', [DaftarController::class, 'cetakdetail'])->middleware(['auth'])->name('daftar.cetak');
Route::get('/eksporexcel', [DaftarController::class, 'eksporexcel'])->middleware(['auth'])->name('daftar.eksporexcel');
